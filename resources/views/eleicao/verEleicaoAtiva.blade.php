    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="fas fa-list me-2"></i>Eleições Ativas</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button class="btn btn-sm btn-primary" onclick="window.location.href='{{ route('votacao') }}';" style="cursor:pointer;">Votar</button>
